    ...
    for solution in selected:
        ...
        for sample in solution.samples:
            ...
            row = {
                ...
                "x_m": round(point[0], 6),
                "y_m": round(point[1], 6),
                "z_m": round(max(0.0, point[2]), 6),
                "confidence": round(float(sample["confidence"]) * np.exp(-sample["reprojection_error_px"] / 24.0), 6),
                ...
                "reprojection_error_px": round(sample["reprojection_error_px"], 6),
                "observed_pixel_x": round(sample["pixel"][0], 6),
                "observed_pixel_y": round(sample["pixel"][1], 6),
                "reprojected_pixel_x": round(sample["reprojected_pixel"][0], 6),
                "reprojected_pixel_y": round(sample["reprojected_pixel"][1], 6),
