...
class SessionRecord(Base):
    ...
    source_video_id: Mapped[uuid.UUID | None] = mapped_column(Uuid, nullable=True)
    latest_analysis_run_id: Mapped[uuid.UUID | None] = mapped_column(Uuid, nullable=True)
    ...
    analysis_runs = relationship("AnalysisRun", back_populates="session")
