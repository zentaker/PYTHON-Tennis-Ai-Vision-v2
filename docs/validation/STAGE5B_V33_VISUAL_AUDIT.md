# Stage 5B v3.3 event-constrained visual audit
...
five v3.2 contact endpoints intersects its uncertainty-expanded player/racket volume;
the maximum excess is 3.86798 m. Therefore Phase B was not executed.

The artifact includes the 20 worst real reprojection frames from v3.2, explicit
