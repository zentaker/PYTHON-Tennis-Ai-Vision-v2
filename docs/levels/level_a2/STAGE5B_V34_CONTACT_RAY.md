...
nodes. Phase B was rejected by the human gate: candidate selection minimized speed and
contact nodes were frozen rather than optimized jointly. Its median/p95/maximum
reprojection errors are 17.6898/53.9555/86.1965 px. Analytics remains blocked.
